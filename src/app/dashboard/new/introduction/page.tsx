...
import ProjectIntroduction from '@/components/introduction/ProjectIntroduction';
...
export default function IntroductionPage() {
        ...
        .insert([
          {
            user_id: user.id,
            name: payload.name,
            description: `Proyecto creado para ${payload.name} en ${payload.location}. Origen ${(payload.decision_metadata.selector_origin as string) ?? '—'}.`,
  ...
  return (
    <div className="h-full">
      ...
      <ProjectIntroduction onCreateProject={handleCreateProject} createLoading={createLoading} />
    </div>
  );
}
